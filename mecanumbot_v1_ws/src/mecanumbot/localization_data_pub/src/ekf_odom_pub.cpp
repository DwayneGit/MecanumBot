...
int main(int argc, char **argv) {
  ...
  ros::Subscriber subForFrontRightCounts = node.subscribe("front_right_ticks", 100, Calc_Right, ros::TransportHints().tcpNoDelay());
  ros::Subscriber subForFrontLeftCounts = node.subscribe("front_left_ticks", 100, Calc_Left, ros::TransportHints().tcpNoDelay());
  ros::Subscriber subForRearRightCounts = node.subscribe("rear_right_ticks", 100, Calc_Right, ros::TransportHints().tcpNoDelay());
  ros::Subscriber subForRearLeftCounts = node.subscribe("rear_left_ticks", 100, Calc_Left, ros::TransportHints().tcpNoDelay());
